...
module.exports = function<T, P, I, TI, PI, C, CX, PL>(
  ...
  let priorityContext: PriorityLevel = useSyncScheduling ? SynchronousPriority : LowPriority;
  ...
  function findNextUnitOfWork() {
    ...
    while (root !== null) {
      if (
        ...
        (highestPriorityLevel === NoWork || highestPriorityLevel > root.current.pendingWorkPriority)
      ) {
  ...
  function commitAllHostEffects() {
    while (nextEffect !== null) {
      ...
      let primaryEffectTag = nextEffect.effectTag & ~(Callback | Err | ContentReset | Ref);
