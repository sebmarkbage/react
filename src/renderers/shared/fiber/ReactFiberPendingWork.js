  ...
  while (workInProgress) {
    if (workInProgress.pendingWorkPriority !== NoWork &&
      ...
      if (workInProgress.childInProgress) {
        console.log('-> childInProgress:', workInProgress.type && workInProgress.type.name || workInProgress.type);
        ...
        console.log('-> child:', workInProgress.type && workInProgress.type.name || workInProgress.type);
