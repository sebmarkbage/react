...
describe('Pooled class', () => {
  ...
  it('should accept poolers with different arguments', () => {
    ...
    PooledClass.addPoolingTo(PoolableClassWithMultiArguments, PooledClass.twoArgumentPooler);
  ...
  it('should throw when the class releases an instance of a different type', () => {
    ...
    }).toThrowError('Trying to release an instance into a pool of a different type.');
  });
